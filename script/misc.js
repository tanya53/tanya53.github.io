 $(document).ready(function(){
    ...
    if (navigator.geolocation) {
      ...
      var str = "http://api.openweathermap.org/data/2.5/weather?lat="+ PEEPLAT + "&lon=" + PEEPLONG +"&APPID=0adedd5f2ad9aced6e02a4c438f532cc"
      $.getJSON(str,function(weather){
            ...
            $(".icon").html("<p><img id='img1' src='http://openweathermap.org/img/w/"+iconval+".png' alt = 'weather icon' height = '150' width='150'></p>");

        var str = "http://api.openweathermap.org/data/2.5/weather?lat="+ latitude + "&lon=" + longitude +"&APPID=0adedd5f2ad9aced6e02a4c438f532cc";
        $.getJSON(str,function(weather){
              ...
              $("#temp2").text(temp2 + ' F');
              var iconval = weather.weather[0].icon
              $(".icon").html("<p><img id = 'img2' src='http://openweathermap.org/img/w/"+iconval+".png' alt = 'weather icon' height = '150' width='150'></p>");
              if (temp < temp2){
